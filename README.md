...
There are four different Python code files that are to be run in sequence. You can find instructional videos on <b>ScriptReader</b> usage on my YouTube channel: https://www.youtube.com/playlist?list=PL8fAaOg_mhoH1wGlEZshxlL9LM7L2w8e_.<br><br>
