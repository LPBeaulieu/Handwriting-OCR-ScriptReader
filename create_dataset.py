...
if __name__ == '__main__':
    ...
    'multipage scanner at a resolution of 300 dpi with the US Letter size setting.\n')
        ...
        for i in range(len(JPEG_file_names)):
            ...
            with open(os.path.join('Training&Validation Data', JPEG_file_names[i][:-4] + '.txt'), 'r', encoding="utf-8") as f:
                ...
                for char in text:
                    ...
                    elif text[character_count].islower():
                        labels.append(text[character_count] + " (lowercase)")
                        character_count+=1
                    ...
                    #expression is required, as Windows folder names
                    #are not case-sensitive.
                    elif text[character_count].isupper():
                        labels.append(text[character_count] + " (uppercase)")
                        character_count+=1
