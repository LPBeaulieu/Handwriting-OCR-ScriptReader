...
if __name__ == '__main__':
    ...
    #Ignore non-critical matplotlib warnings
    #when it buils a font cache so that it knows
    #which text styles are available on the training
    #graphs.
    ...
    def get_dataloaders(batch_size=64):
        ...
        blocks = (ImageBlock(cls=PILImageBW), CategoryBlock),
                ...
                ).dataloaders(path, bs=batch_size, num_workers=0)
    ...
    def fit(epochs=5, learning_rate = 0.003):
        learn = Learner(get_dataloaders(), cnn_structure(), 
